% ============================================================================
% model-doc.tex —— index.html “模型介绍”面板的完整推导文稿（公式唯一源）
%
% 本文件可独立编译（xelatex，ctexart 支持中文）。同时它是 index.html 中
...
%   5. 删除临时工作区。项目目录只保留 index.html 与 model-doc.tex。
% ============================================================================
...
\author{index.html 模型介绍面板源文稿}
\date{}
\begin{document}
\maketitle

\noindent 本文与 \texttt{index.html} 的仿真实现逐一对应。单位制：长度 cm、电势 V、浓度 cm$^{-3}$、电荷 C。
常数（$T=300\,\mathrm{K}$）：
